...
To reproduce the results presented in the paper, please follow these steps:
  ...
  2. Clone the repository
       * Clone this repository, and Git LFS will automatically detect the pointer file and download the datacube, which is ```data.zip``` file during this process. This will probably take some time.
...
| Bayesian method | bayesian-torch | [https://github.com/IntelLabs/bayesian-torch.git](https://github.com/IntelLabs/bayesian-torch.git) |
| Bayesian method | pytagi | [https://github.com/lhnguyen102/cuTAGI](https://github.com/lhnguyen102/cuTAGI) |
