...
To reproduce the results presented in the paper, please follow these steps:
  ...
  2. Clone the repository
       * Clone this repository, and Git LFS will automatically detect the pointer file and download the ```data.zip``` file during this process. This may take some time.
